...
import com.leixun.smartcushion.LauncherActivity;
...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(View arg0, int arg1) {
        ...
        if (arg1 == views.size() - 1) {
        	Button mStartButton = (Button) arg0
            ...
            mStartButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    // 设置已经引导
                	XMLPreferences.getInstance(activity).setIsFirstStartApplication(false);
                    setGuided();
                    goHome();
    ...
    private void goHome() {
		...
		String preaddress = CushionPreferences.getInstance(
				activity).getCurrectConnectorCushion(
					null);
		if (preaddress==null){
        ...
        activity.finish();
        // 跳转
    	XMLPreferences.getInstance(activity).setIsFirstStartApplication(true);
